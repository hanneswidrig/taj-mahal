...
class ApplicationTestCaseDay0(FlaskTestCase):
    ...
    def test_index(self):
        ...
        self.assertTrue(b'Gardener\'s Exchange' in resp.data,
...
class ApplicationTestCaseDay1(FlaskTestCase):
    ...
    def test_listing_purchase(self):
        ...
        resp = self.client.post(
            "/login",
            data=dict(csrf_token=csrf, email="tim@ours.org", password="tim"),
    ...
    def test_login(self):
        ...
        resp = self.client.post(
            "/login",
            data=dict(
                csrf_token=csrf, email="tim@ours.org", password="nottim"),
            follow_redirects=True)
        self.assertTrue(b'Gardener\'s Exchange' in resp.data,
                        "Login Day 1 - Missing site title.")
